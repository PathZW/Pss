 ...
 *---------------------------------------------------------------------------*/
  ...
  static void NOR0_DriverEvent (uint32_t event) {
    efs_DrvEvent (event, &fs_nor0_vol);
  }
 ...
 *---------------------------------------------------------------------------*/
  ...
  static void NOR1_DriverEvent (uint32_t event) {
    efs_DrvEvent (event, &fs_nor1_vol);
  }
...
__inline static void fs_config_flash (char num) {
  switch (num) {
    ...
    case '0':
      ...
      fs_nor0_vol.Drv         = &CREATE_SYMBOL (Driver_Flash, NOR0_DRIVER);
      fs_nor0_vol.Callback    = &NOR0_DriverEvent;
      fs_nor0_vol.Dev.Timeout = &fs_nor0_flash_tout;
      break;
#endif /* NOR0_ENABLE */
    ...
    case '1':
      ...
      fs_nor1_vol.Drv         = &CREATE_SYMBOL (Driver_Flash, NOR1_DRIVER);
      fs_nor1_vol.Callback    = &NOR1_DriverEvent;
      fs_nor1_vol.Dev.Timeout = &fs_nor1_flash_tout;
      break;
#endif /* NOR1_ENABLE */
  }
}
 ...
 *----------------------------------------------------------------------------*/
 ...
 fsStatus efs_seek  (int32_t h, uint32_t a)                        { (void)h; (void)a;          return (fsError); }
 ...
 int32_t  fat_flush(int32_t h)                                       { (void)h;                   return (-1);      }
 int32_t  fat_flen (int32_t h)                                       { (void)h;                   return (-1);      }
 fsStatus fat_seek (int32_t h, uint32_t a)                           { (void)h; (void)a;          return (fsError); }
