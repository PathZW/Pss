 ...
 *
 * $Date:        7. April 2020
 * $Revision:    V2.13      modified by linghu0060 (RTE_DEVICE_FRAMEWORK_CLASSIC:
...
#define SPI_CR2_FRF             (0x10)      //!<Frame Format
...
#endif
#ifndef GPIO_AF5_SPI4
#define GPIO_AF5_SPI4          ((uint8_t)0x05)  /* SPI4 Alternate Function mapping  */
#endif
#ifndef GPIO_AF5_SPI5
#define GPIO_AF5_SPI5          ((uint8_t)0x05)  /* SPI5 Alternate Function mapping  */
#endif
#ifndef GPIO_AF5_SPI6
#define GPIO_AF5_SPI6          ((uint8_t)0x05)  /* SPI6 Alternate Function mapping  */
#endif
#ifndef GPIO_AF6_SPI1
...
#endif
#ifndef GPIO_AF6_SPI4
#define GPIO_AF6_SPI4          ((uint8_t)0x06)  /* SPI4 Alternate Function mapping  */
#endif
#ifndef GPIO_AF6_SPI5
#define GPIO_AF6_SPI5          ((uint8_t)0x06)  /* SPI5 Alternate Function mapping  */
#endif
#ifndef GPIO_AF6_SPI6
#define GPIO_AF6_SPI6          ((uint8_t)0x06)  /* SPI6 Alternate Function mapping  */
#endif
#ifndef GPIO_AF7_SPI1
#define GPIO_AF7_SPI1          ((uint8_t)0x07)  /* SPI1 Alternate Function mapping  */
#endif
#ifndef GPIO_AF7_SPI2
#define GPIO_AF7_SPI2          ((uint8_t)0x07)  /* SPI2 Alternate Function mapping  */
#endif
#ifndef GPIO_AF7_SPI3
#define GPIO_AF7_SPI3          ((uint8_t)0x07)  /* SPI3 Alternate Function mapping  */
#endif
#ifndef GPIO_AF7_SPI4
#define GPIO_AF7_SPI4          ((uint8_t)0x07)  /* SPI4 Alternate Function mapping  */
#endif
#ifndef GPIO_AF7_SPI5
#define GPIO_AF7_SPI5          ((uint8_t)0x07)  /* SPI5 Alternate Function mapping  */
#endif
#ifndef GPIO_AF7_SPI6
#define GPIO_AF7_SPI6          ((uint8_t)0x07)  /* SPI6 Alternate Function mapping  */
#endif

/*----------------------------------------------------------------------------*/
#ifndef SPI1_NVIC_PRIO
#define SPI1_NVIC_PRIO          (0x08U)
#endif
#ifndef SPI2_NVIC_PRIO
#define SPI2_NVIC_PRIO          (0x08U)
#endif
#ifndef SPI3_NVIC_PRIO
#define SPI3_NVIC_PRIO          (0x08U)
#endif
#ifndef SPI4_NVIC_PRIO
#define SPI4_NVIC_PRIO          (0x08U)
#endif
#ifndef SPI5_NVIC_PRIO
#define SPI5_NVIC_PRIO          (0x08U)
#endif
#ifndef SPI6_NVIC_PRIO
#define SPI6_NVIC_PRIO          (0x08U)
#endif
/*----------------------------------------------------------------------------*/
...
// SPI1 configuration definitions
  ...
  #endif
  #ifndef SPI1_NSS_GPIO_PUPD
  #define SPI1_NSS_GPIO_PUPD      GPIO_PULLUP
  #endif
  ...
  #define MX_SPI1_SCK_GPIO_AF     GPIO_AF5_SPI1
    ...
    #define MX_SPI1_NSS_GPIO_PuPd  SPI1_NSS_GPIO_PUPD
...
// SPI2 configuration definitions
  ...
  #endif
  #ifndef SPI2_NSS_GPIO_PUPD
  #define SPI2_NSS_GPIO_PUPD      GPIO_PULLUP
  #endif
  ...
  #define MX_SPI2_SCK_GPIO_AF    GPIO_AF5_SPI2
    ...
    #define MX_SPI2_NSS_GPIO_PuPd  SPI2_NSS_GPIO_PUPD
...
// SPI3 configuration definitions
  ...
  #endif
  #ifndef SPI3_NSS_GPIO_PUPD
  #define SPI3_NSS_GPIO_PUPD      GPIO_PULLUP
  #endif
  ...
  #define MX_SPI3_SCK_GPIO_AF    GPIO_AF6_SPI3
    ...
    #define MX_SPI3_NSS_GPIO_PuPd   SPI3_NSS_GPIO_PUPD
...
// SPI4 configuration definitions
  ...
  #endif
  #ifndef SPI4_NSS_GPIO_PUPD
  #define SPI4_NSS_GPIO_PUPD      GPIO_PULLUP
  #endif
  ...
  #define MX_SPI4_SCK_GPIO_AF   GPIO_AF5_SPI4
    ...
    #define MX_SPI4_NSS_GPIO_PuPd  SPI4_NSS_GPIO_PUPD
...
// SPI5 configuration definitions
  ...
  #endif
  #ifndef SPI5_NSS_GPIO_PUPD
  #define SPI5_NSS_GPIO_PUPD      GPIO_PULLUP
  #endif
  ...
  #define MX_SPI5_SCK_GPIO_AF   GPIO_AF5_SPI5
    ...
    #define MX_SPI5_NSS_GPIO_PuPd  SPI5_NSS_GPIO_PUPD
...
// SPI6 configuration definitions
  ...
  #endif
  #ifndef SPI6_NSS_GPIO_PUPD
  #define SPI6_NSS_GPIO_PUPD      GPIO_PULLUP
  #endif
  ...
  #define MX_SPI6_SCK_GPIO_AF    GPIO_AF5_SPI6
    ...
    #define MX_SPI6_NSS_GPIO_PuPd  SPI6_NSS_GPIO_PUPD
...
typedef const struct _SPI_PIN {
  GPIO_TypeDef         *port;           // Port                 GPIO_TypeDef         *port;    
  uint16_t              pin;            // Pin                  uint32_t              pin;     
  uint16_t              af;             // Alternate function   uint32_t              af;      
  uint16_t              pupd;           // Pull up/down         uint8_t               pupd;    
  uint16_t              speed;          // Speed                uint8_t               speed;   
  uint32_t              reserved;       // Reserved             uint16_t              reserved;
} SPI_PIN;
