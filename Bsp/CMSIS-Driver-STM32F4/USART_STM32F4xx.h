 ...
 * $Revision:    V2.8       modified by linghu0060 (RTE_DEVICE_FRAMEWORK_CLASSIC:
...
#ifdef   _RTE_                  // RTE_DEVICE_FRAMEWORK_CLASSIC
#include "RTE_Components.h"     // Component selection
#else
#if !defined(RTE_DEVICE_FRAMEWORK_CLASSIC) && !defined(RTE_DEVICE_FRAMEWORK_CUBE_MX)
...
#endif
#ifndef GPIO_AF8_USART3
#define GPIO_AF8_USART3     ((uint8_t)0x08)     /* UART4  Alternate Function mapping    */
#endif
...
#endif
#ifndef GPIO_AF8_UART7
#define GPIO_AF8_UART7      ((uint8_t)0x08)     /* UART7  Alternate Function mapping    */
#endif
#ifndef GPIO_AF8_UART8
#define GPIO_AF8_UART8      ((uint8_t)0x08)     /* UART8  Alternate Function mapping    */
#endif
#ifndef GPIO_AF11_UART4
#define GPIO_AF11_UART4     ((uint8_t)0x0B)     /* UART4  Alternate Function mapping    */
#endif
#ifndef GPIO_AF11_UART5
#define GPIO_AF11_UART5     ((uint8_t)0x0B)     /* UART5  Alternate Function mapping    */
#endif
#ifndef GPIO_AF11_UART9
#define GPIO_AF11_UART9     ((uint8_t)0x0B)     /* UART9  Alternate Function mapping    */
#endif
#ifndef GPIO_AF11_UART10
#define GPIO_AF11_UART10    ((uint8_t)0x0B)     /* UART10 Alternate Function mapping    */
#endif

/*----------------------------------------------------------------------------*/
#ifndef USART1_NVIC_PRIO
#define USART1_NVIC_PRIO        (0x08U)
#endif
#ifndef USART2_NVIC_PRIO
#define USART2_NVIC_PRIO        (0x08U)
#endif
#ifndef USART3_NVIC_PRIO
#define USART3_NVIC_PRIO        (0x08U)
#endif
#ifndef UART4_NVIC_PRIO
#define UART4_NVIC_PRIO         (0x08U)
#endif
#ifndef UART5_NVIC_PRIO
#define UART5_NVIC_PRIO         (0x08U)
#endif
#ifndef USART6_NVIC_PRIO
#define USART6_NVIC_PRIO        (0x08U)
#endif
#ifndef UART7_NVIC_PRIO
#define UART7_NVIC_PRIO         (0x08U)
#endif
#ifndef UART8_NVIC_PRIO
#define UART8_NVIC_PRIO         (0x08U)
#endif
#ifndef UART9_NVIC_PRIO
#define UART9_NVIC_PRIO         (0x08U)
#endif
#ifndef UART10_NVIC_PRIO
#define UART10_NVIC_PRIO        (0x08U)
#endif
/*----------------------------------------------------------------------------*/
...
// USART1 configuration definitions
  ...
  #endif
  #ifndef USART1_RX_GPIO_PUDP
  #define USART1_RX_GPIO_PUDP         GPIO_PULLUP
  #endif
  #ifndef USART1_CTS_GPIO_PUDP
  #define USART1_CTS_GPIO_PUDP        GPIO_PULLUP
  #endif
    ...
    #define MX_USART1_RX_GPIO_PuPd  USART1_RX_GPIO_PUDP
    ...
    #define MX_USART1_CTS_GPIO_PuPd  USART1_CTS_GPIO_PUDP
...
// USART2 configuration definitions
  ...
  #endif
  #ifndef USART2_RX_GPIO_PUDP
  #define USART2_RX_GPIO_PUDP         GPIO_PULLUP
  #endif
  #ifndef USART2_CTS_GPIO_PUDP
  #define USART2_CTS_GPIO_PUDP        GPIO_PULLUP
  #endif
    ...
    #define MX_USART2_RX_GPIO_PuPd  USART2_RX_GPIO_PUDP
    ...
    #define MX_USART2_CTS_GPIO_PuPd  USART2_CTS_GPIO_PUDP
...
// USART3 configuration definitions
  ...
  #endif
  #ifndef USART3_RX_GPIO_PUDP
  #define USART3_RX_GPIO_PUDP         GPIO_PULLUP
  #endif
  #ifndef USART3_CTS_GPIO_PUDP
  #define USART3_CTS_GPIO_PUDP        GPIO_PULLUP
  #endif
    ...
    #define MX_USART3_RX_GPIO_PuPd  USART3_RX_GPIO_PUDP
    ...
    #define MX_USART3_CTS_GPIO_PuPd  USART3_CTS_GPIO_PUDP
...
// UART4 configuration definitions
  ...
  #endif
  #ifndef UART4_RX_GPIO_PUDP
  #define UART4_RX_GPIO_PUDP         GPIO_PULLUP
  #endif
    ...
    #define MX_UART4_RX_GPIO_PuPd  UART4_RX_GPIO_PUDP
...
// UART5 configuration definitions
  ...
  #endif
  #ifndef UART5_RX_GPIO_PUDP
  #define UART5_RX_GPIO_PUDP         GPIO_PULLUP
  #endif
    ...
    #define MX_UART5_RX_GPIO_PuPd  UART5_RX_GPIO_PUDP
...
// USART6 configuration definitions
  ...
  #endif
  #ifndef USART6_RX_GPIO_PUDP
  #define USART6_RX_GPIO_PUDP         GPIO_PULLUP
  #endif
  #ifndef USART6_CTS_GPIO_PUDP
  #define USART6_CTS_GPIO_PUDP        GPIO_PULLUP
  #endif
    ...
    #define MX_USART6_RX_GPIO_PuPd  USART6_RX_GPIO_PUDP
    ...
    #define MX_USART6_CTS_GPIO_PuPd  USART6_CTS_GPIO_PUDP
...
// UART7 configuration definitions
  ...
  #endif
  #ifndef UART7_RX_GPIO_PUDP
  #define UART7_RX_GPIO_PUDP         GPIO_PULLUP
  #endif
    ...
    #define MX_UART7_RX_GPIO_PuPd  UART7_RX_GPIO_PUDP
...
// UART8 configuration definitions
  ...
  #endif
  #ifndef UART8_RX_GPIO_PUDP
  #define UART8_RX_GPIO_PUDP         GPIO_PULLUP
  #endif
    ...
    #define MX_UART8_RX_GPIO_PuPd  UART8_RX_GPIO_PUDP
...
// UART9 configuration definitions
  ...
  #endif
  #ifndef UART9_RX_GPIO_PUDP
  #define UART9_RX_GPIO_PUDP         GPIO_PULLUP
  #endif
    ...
    #define MX_UART9_RX_GPIO_PuPd  UART9_RX_GPIO_PUDP
...
// UART10 configuration definitions
  ...
  #endif
  #ifndef UART10_RX_GPIO_PUDP
  #define UART10_RX_GPIO_PUDP         GPIO_PULLUP
  #endif
    ...
    #define MX_UART10_RX_GPIO_PuPd  UART10_RX_GPIO_PUDP
